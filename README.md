...
⚠️ **IMPORTANT!** ⚠️  This app is a personal project, so the code might not be optimized for smoother user's experience. For first time loading, the web might take a few seconds.
