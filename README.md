...
The use of generative AI includes: Visual Studio Code's Copilot to help in the coding syntax and writing comments/docstring, as well as OpenAI's Chat GPT to help with identifying runtime error. Outside of those, including problem formulation and framework of thinking, code logical reasoning and writing, from database management using SQLite to web development using Flask, all is done mostly by the author.
